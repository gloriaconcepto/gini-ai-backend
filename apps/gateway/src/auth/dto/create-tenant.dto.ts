...
export class CreateTenantDto {
  ...
  @ApiPropertyOptional({ example: 'acme.com', description: 'Corporate Domain Name' })
  @IsString()
  @IsOptional()
  domainName?: string;

  @ApiPropertyOptional({ example: 'Enterprise', description: 'Subscription Tier' })
  @IsEnum(['Basic', 'Pro', 'Enterprise'])
  @IsOptional()
  subscriptionTier?: 'Basic' | 'Pro' | 'Enterprise';

  @ApiPropertyOptional({ example: '12-3456789', description: 'Company Registration Number / Tax ID' })
  @IsString()
  @IsOptional()
  taxId?: string;

  @ApiPropertyOptional({ example: '123 Main St, USA', description: 'Billing Address / Country' })
  @IsString()
  @IsOptional()
  billingAddress?: string;

  @ApiPropertyOptional({ example: '+1-555-0198', description: 'Primary Contact Phone Number' })
  @IsString()
  @IsOptional()
  contactPhone?: string;
}
